...
-   v1.0.9 to v1.0.10 - backup registry, download and run the update1010.sh script.
    
-   v1.0.8 to v1.0.9 - backup registry, download and run the update109.sh script.
    
-   v1.0.7 to v1.0.8 - backup registry, download and run the update108.sh script.
    
-   v1.0.6 to v1.0.7 - backup registry, download and run the update107.sh script.
    
-   v1.0.5 to v1.0.6 - backup registry, download and run the update106.sh script.
    
-   v1.0.4 to v1.0.5 - backup registry, download and run the update105.sh script.
    
-   v1.0.3 to v1.0.4 - backup registry, download and run the update104.sh script.
    
-   v1.0.2 to v1.0.3 - backup registry, download and run the update103.sh script.
    
-   v1.0.1 to v1.0.2 - backup registry, download and run the update102.sh script.
    
-   v1.0.0 to v1.0.1 - backup registry, download and run the update101.sh script.
    
-   v1.0.0-RC4 to v1.0.0 - backup registry, refer to upgrade.md.
...
-   Tabler, whose elegant and intuitive interface design has greatly influenced the user experience of Namingo.
-   leemunroe/responsive-html-email-template, for providing a great email template for our mailing system.
