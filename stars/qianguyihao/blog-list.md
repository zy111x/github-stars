...
代表文章：《李如一 | 论推荐之难》《李如一在《好奇心日報》（Qdaily.com）文章列表》
...
MiaoYan / Pake / XRender / WeexUi / cz-emoji-chinese 等产品的开发者。

### 唐巧

-   博客地址：http://blog.devtang.com/

唐巧，男，80 后，程序员。作为核心员工在 猿辅导 参与创业。曾作为产品技术负责人孵化了 小猿搜题 和 小猿口算，现在作为负责人在孵化某新业务。

前端、后端、iOS端都有涉及。著有《iOS 开发进阶》 一书。曾开发 网易邮箱、网易微博、有道云笔记、猿题库、小猿搜题。本博客主要的内容包括 iOS 开发技巧、创业感悟、读书心得、产品研究笔记。
...
目前专注前端领域，包括但不限于 React、Flutter、iOS、Chromium 等。同时其他技术也基本都会一点儿，戳这里可以浏览我学生时代的一些作品~

现在每周都有在写周刊，但本博客不会全量同步周刊内容。若你感兴趣的话，可以访问 Airing Weekly 查看所有周刊。
...
是一个兴趣广泛的人，其实也就是什么都不会，日常看看电影，书，偶尔写写博客，影评，都非专业，发发自己所思所想而已。

著有电子书：《Markdown 书写风格指南》《Gitbook 使用教程》《Kafka 官方文档中文版》等。

### yihong0618

-   博客地址：https://github.com/yihong0618

喜爱游戏，跑步，读书，编程。 项目大多和这些相关。用 GitHub 记录blog 和生活日常。
...
吕靖（JimmyLv），Parabol 高级全栈工程师；前阿里巴巴高级前端工程师、前 ThoughtWorks 咨询师、《React 学习之道》译者。想做产品，却误入程序世界爱上写作的摄影师。
...
我从年少时期开始接触电脑，因对于黑客的迷恋而进入软件相关工作，又在不断的求学过程中逐步明确了自己的路线，经历过不断的城市、人、事、物，现在开始在一边求活，一边追求做一些自己想做的事情，关于我的故事，你可以阅读《白宦成简史》。

### 谢益辉

-   博客地址：https://yihui.org

一个在美帝工作的湖北宜昌人，比郭敬明高，比博尔特白，比刘欢脖子长，比巩汉林结实，比刘翔痘少，比布拉德皮特中文说得好…… 正经介绍请参见我的简历。
...
创办了掘金（2014-2016），在 峰瑞资本 深造过（2016-2019），目前在 真格基金（2019-至今）。
...
我是一个普通程序员，擅长数据可视化和 Web 前端开发，可以在我的 Github 上找到我做的开源项目。闲言碎语发 Twitter 和微博, 偶尔写写博客，每周写一篇周刊，所知所学会整理到 Wiki，当然也有个 English Blog。

编程之外，我喜欢跑步，徒步，越野跑。你可以在 Activity 上看到我所有的运动轨迹和训练数据，你也可以关注我的 Strava。风景照我偶尔会发到 Instagram，也会突发奇想上传一些视频到 Bilibili 或 YouTube。

博客已经写了十多年了。写作用于思考，博客用于展示思考的结果，多数文章为自己而写，但也希望能为他人提供价值，「"奇"文共欣赏，疑义相与析」。
...
代表文章：《Sublime Text 全程指引 by Lucida》《我的算法学习之路》《程序员必读书单 1.0 — 六年后的回顾》
...
我在之前建立了一个个人的公开 Wiki和 Blog，让我养成了记笔记，多写东西的习惯，由于习惯已经养成，所以就不再纠结博客的形式问题了，把个人的笔记，博客所有的产出通通都放在这里，这样让我自己更好维护，更省心，之前需要两个地方来回切换，有点麻烦，博客全部内容托管在这个Github 的 Repo 里。
...
目前是国内的一名在读研究生，主修计算机专业，也辅修过动画，但可惜学艺不精。 业余热衷开源与前端方面，主要包括写各种奇奇怪怪的小网站（雾）和开源项目，也有尝试写一些科幻小说。（还是个死宅二次元） 对了，目前我也是 Element Plus 团队成员，不知有没有听说过？
...
当然我也有几个隐藏的有些不切实际的梦想，比如成为一名独立游戏开发者、漫画家、作家、动画人、全职开源作者。 简而言之就是可以不用上班，自己在家做觉得有趣的事情的人！（想必大家也是）
...
代表文章《iPotato | 浅谈《开端》在剧作上的瑕疵》《iPotato | 当我反对中医时，我在反对什么？》
...
本博客的历史最早可以追溯到我的高中岁月，从 WordPress 到 Typehco 再到现在的 Hexo ，折腾了不少博客系统，但文章积累得并不多。这里立下个 flag ，以后要努力丰富本博客的内容，做到质优量高。 如果你对我的博客折腾历史感兴趣，可以在 log 中查看细节。
...
如何在工作中学习 所有方法我都记录在这篇文章中了，希望对你能有所帮助。所有新文章从这里可以看到，即使再简单的一篇总结我可以持续总结三五年，有新的发现、感悟都是直接在原文上增减，不会发表新的文章。
...
2000年毕业于中国科技大学，先后在清华同方、Motorola、Comcast、等公司工作，现在在微博做架构和开发工作。极客时间专栏《Go并发编程实战课》作者。
...
-   技术分享PPT：https://github.com/rfyiamcool/share\_ppt
...
一名从事泛客户端开发的软件工程师。致力于前端标准化、工业化，让前端开发更加有序且可快速装配，为新型开发方式及协作模式做支撑。拥护去中心化的开放网络（decentralized open web）。除了编程，我还喜欢写作、思考、旅行和日语等。

自成立以来时不时在更新，经历了几个阶段性的重大变革，无论是设计风格、访问速度，还是内容质量、阅读体验都得到了很大提升。

代表文章：《聊聊中后台前端应用：目录结构划分模式》《聊聊前端 UI 组件：核心概念》
...
个人认为把复杂的东西用平易近人的方式描述出来是一种很重要的能力，这里是我写的一些科普性的系列文章， 更多的文章请访问 此处。
...
阿里前端开发工程师。代表文章：《这一年我的对组件的思考》《Vite + React 组件开发实践》
...
代表文章：《初识网络原理: 从浏览器地址栏输入 URL 到页面渲染之间都经历了什么 | Anran758's blog》《Flexbox 布局入门 | Anran758's blog》《Flexbox 布局实际用例 | Anran758's blog》《计算机网络原理笔记 | Anran758's blog》
...
中文昵称「於清樂」「二花」，英文 ID「ryan4yin」「ryan\_yin」。运维工程师。在 Mobiuspace 担任 SRE 工程师，主要负责维护与优化 K8s 服务平台及流量链路，分析与管控 AWS/GCP 云计算成本。
...
独立开发者。Klib、iPic、iText、iHosts、iPaste、iTimer 作者。
...
-   Ubuntu Tweak：2007 年时在大学时做起来的开源项目，曾经是 Ubuntu 上必装的软件之一，现已停止维护。
-   Manico：2013 年发布，为 macOS 设计开发的一个小巧易用的 App 快速启动和切换工具，目前在维护状态；
-   奇点 for 微博：2015 年发布，为 iOS 设计的一个第三方微博客户端，带给你不一般的刷微博体验，目前已下架；
-   效率控：2019 年发布，为 iOS 设计的聚合了二十余款各种独立功能的实用小工具型 App，从缩小图片、图片打码到 PDF 水印。2020 年推出了 macOS 版本，目前在维护状态；
-   One Switch：2019 年发布，为 macOS 设计的一个快捷开关工具，通过内置二十余个功能开关可以方便地完成诸如「隐藏桌面」、「切换黑暗模式」等操作，至今仍在不断更新；
-   Moment：2020 年发布，为 macOS 设计的简洁美观的记录日程与时间进度的工具，目前在维护状态；
...
开发作品：‎谜底时钟、OffScreen、‎方块小子、‎空空相册、谜底黑胶、‎花样文字、‎谜底空白、捷径社区
...
一名生活在上海的前端开发工程师，也是一位独立开发者；创建了简单简历, 五分钟打造程序员的金牌简历。 同时作者在教学上有一点天赋，在 2016 年和哥们出过一本书；从18年下半年到现在，在慕课网出品了 **7** 套课程，它们是作者目前的主要收入来源。
...
广东土著，现居广州，日常活跃于番禺和海珠。小睡眠产品长，四只猫的首席铲屎官，Emoji/科幻片/摄影爱好者。
...
本科 GIS 专业，硕士方向人文地理与旅游规划。之后莫名成为互联网从业者，做了 3 年产品经理，1 年用户研究，4 年交互设计。
...
「片语」设计师。作者追求干净优雅的视觉风格与简洁易用的产品使用体验，相信人类崇尚善良与美好的本性。 片语：回顾过去 · 记录当下 · 感知未来。
...
代表文章：《AI 应用第一次大爆发来了：一文入门 ChatGPT 官方 API 文档解读》《人工智能 LLM 革命破晓：一文读懂当下超大语言模型发展现状》
...
代表文章：《自由主义的好奇心日报 - TSBBLOG》《《好奇心日报》番外杂志《小鸟 Aves》 - TSBBLOG》
...
代表文章比如：《隐形眼镜指南 - Battle Le 博客》《个人备份指北 - Battle Le 博客》
...
在爱否科技做过主笔，期间最满意的作品是 Nintendo Switch 评测。给很多媒体供过稿，作品也在本博客多有发布。目前主要为极客公园供稿，写硅谷、消费电子以及泛文娱。
...
家在成都，目前在杭州工作。这个站点由我自己设计，并托管在 Farbox 。
...
GSeeker是一个专门专注Google和互联网新闻的博客，前身是幻灭的麦克风，2006年8月份改名了GSeeker并继续由原作者Ken Wong继续编辑！在GSeeker里面可以了解到很多Google的应用技巧及最新的Google有趣的东西。
...
干工程师/Indie Hacker，目前在做 AlgoCasts，专注于制作算法教学视频。在此之前我分别在豌豆荚担任后端工程师以及在 GrowingIO 担任后端技术负责人，同时是个 Scala 选手，Akka 贡献者，北京 Scala Meetup 组织者，Reactive Design Pattern 译者。
...
创业中。之前在 Fitbit (领导机器学习团队) 和 Google (广告和无人驾驶) 干活。华盛顿大学人工智能博士，南京大学数学学士。
...
第四号大桥是链接爱丁堡和圣安德鲁斯的一座红色的大桥；它也是苏格兰工业革命的标志。坐火车通过第四号大桥的时候，是我在真正的家乡外唯一会有回家之感情的地方。如今逐渐搬离苏格兰，不知以后和它的缘分几何，那就索性用这不断且永远通往“故乡”的桥来命名写作的一隅之地吧。
...
Go语言代码的贡献者(Chaishushan), 《Go语言圣经》翻译者, 《Go语言高级编程》开源免费图书作者, 《WebAssembly标准入门》图书作者。
...
高中辍学，入行相对较早。喜欢用代码用技术解决问题的感觉。 但工作中团队管理、系统架构师的工作占比更大。

应用方向上擅长高性能应用和数智化应用，业务方向上对金融和互联网实践比较丰富，其中在银行和电商方向有些比较厚的实践总结可以分享。

目前在杭州和成都两地，喜欢骑行，喜欢泪湖、枪花，其余爱好不多了。

喜欢价值创造的感觉，希望未来能创建自己的公司，或入伙一个更需要我的公司，以此为目标提升学习中。这里写了一个简单经历回顾。
...
iOS 开发者，也是「绝绝子生成器」的开发者。喜欢让我们生活得更好、更轻松的东西，比如大部分苹果的产品。
...
宋天伦，来自新疆石河子。毕业于**霍格沃茨魔法学校**，主修魔药学（Potions）、魔咒课（Charms）、黑魔法防御术（Defence Against the Dark Arts）、变形学（Transfiguration）。我喜欢摄影、阅读、观影、写作、演讲，安静的做事情。我本科阶段读于河南工业大学（2016-2020），空间信息与数字技术专业，主修计算机、地图及相关课程。在这里有一份我的个人简历，包含我的经历、技能以及主要的开源项目。本科院校距家 3000 多公里、横跨半个中国，一生中走过的地方不多，但我想去到更多的地方。
...
henix ，程序员，现居深圳。关注开放互联网，追求代码之美。日本漫画爱好者，CLAMP 老师粉丝。
...
2013年毕业于中北大学的软件工程专业，成绩还算不错，而且在学校的ACM实验室锻炼了很长的时间，熟悉常用的算法；也经常鼓捣些小东西，虽然没用到实际中，不过也提高了自己的编程能力，逐渐地喜欢上了前端开发，喜欢javascript+css做出的页面特效，喜欢HTML5+CSS3的新技术。从一开始，就选择了做前端开发，因为觉得前端开发更贴近用户，能够倾听用户的声音，更好玩，更有意思，美的更直观。我们总是在尝试最新的技术，尝试更炫的效果，希望更能优化用户的体验效果。
...
已成年的 00 后，老家贵州，现在北京。想成为独立开发者的在读医学生。活跃在即刻：GVenusLeo。了解我的更多信息：Yellow Page
...
代表文章：《电子书一键摆烂ABC》《在kindle上阅读k2pdfopt重排过的PDF电子书》
...
代表文章：《Kindle Unlimited 电子书包月服务和微信读书年卡服务哪个更合算》
...
曾供职于中国矿业大学翔工作室后端组,也是后端组的前端er，热爱web技术。

2017年12月——5月, 在百度实习(划水•摸鱼) 2018年12月——2019年3月, 在美团点评实习(端茶•倒水) 2019年07月——至今, 在美团点评搬砖(喝•白开水)
...
毕业于华南师范大学，前 Tencent 前端工程师（关注 Web 开发与在线教育领域），目前在 MoeGo 工作。业余在维护 0xFFFF 技术社区，关注 CS 核心学习氛围、开源文化的构建。

项目 & 作品：

-   面向计算机自学爱好者的：0xFFFF 社区
    
-   微博转换 RSS 订阅源：weibo-rss
    
-   试图帮助读者对 Web 领域建立 Overview 的：Web 开发入门指南
...
代表文章：《字体漫谈-网站字体最佳实践》《再提示『您的磁盘几乎已满』算我输》
...
我很宅，朋友很少，也不喜欢刻意地去和人保持联系、保持熟络。建了这个博客，下次遇到新朋友直接把链接甩过去，就不必再重头解释一遍我自己，这是我的初衷。按照编程原则来说这叫做 Don’t Repeat Yourself, keep DRY. 史铁生说「一旦走进深处，人与人就是相互的迷宫」，这个博客就是名为「马自立」的迷宫。

### 颜海镜

-   博客地址：https://yanhaijing.com/

知名技术博主，开源达人，《React状态管理与同构实战》作者。目前就职于美团点评，从事Web前端开发工作。
...
> “If you’re thinking without writing, you only think you’re thinking.” 我越发体会到，无法在不写作的情况下梳理脑海中的大量想法与片段。写作帮助我更好的思考总结，得出结论，清空大脑，然后行进到下一个话题。
...
这个Blog主要是用来存放一些自己写的项目的展示，同时也是用来存放笔记,方便自己以后的开发用的. 同时也会时不时的分享一下自己的照片集、音乐歌单、菜谱、美食游记之类的生活片段。现在太多学CS的，仅仅是把Blog变成了一个笔记本，对于一个Blog来说，这太过冷冰冰的了。有一些个人的色彩，生活片段的记录，可能才会是一个有意思的Blog。
