...
Once you have created an account and store on Lemon Squeezy, make sure you're in **Test mode**, then go to Settings > API and create a new API key. Copy the key and paste it into `.env` file where it says `LEMONSQUEEZY_API_KEY=`.
