...
-   **\[2026-09-05\]** 更新 Microduck 双足强化学习教程：新增 BallKick 非对称 actor-critic、奖励与随机化拆解，提供独立训练和 ONNX 导出命令，并接入官方 Microduck Sandbox，讲清 MuJoCo WebAssembly、onnxruntime-web、Three.js 与 50 Hz 浏览器闭环；本机实测右脚策略成功触球并保存画面与 QA 记录。
