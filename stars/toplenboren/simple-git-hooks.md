...
export SKIP\_INSTALL\_SIMPLE\_GIT\_HOOKS=1
...
If you need to bypass hooks for multiple Git operations, setting the SKIP\_SIMPLE\_GIT\_HOOKS environment variable can be more convenient. Once set, all subsequent Git operations in the same terminal session will bypass the associated hooks.

# Set the environment variable
export SKIP\_SIMPLE\_GIT\_HOOKS=1
...
If you have the option to set arguments or environment variables, you can use the --no-verify option or the SKIP\_SIMPLE\_GIT\_HOOKS environment variable.
...
export SIMPLE\_GIT\_HOOKS\_RC="$HOME/.simple-git-hooks.rc"
