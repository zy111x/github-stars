...
> _在**手机**上独立运行 CFST 测速的简单教程：**Android、Android APP、Android APP、IOS**_
...
3.  输入带参数的命令，如：`cfst -tl 200 -dn 20` 即可运行
...
cfst -httping -tp 80 -url http://cdn.cloudflare.steamstatic.com/steam/apps/5952/movie\_max.webm
...
cfst -tp 80 -url http://speed.cloudflare.com/\_\_down?bytes=99999999
...
-   _https://github.com/Hsia97/CFSTAPP_  
    _**CFST 安卓版 APP #638**_
