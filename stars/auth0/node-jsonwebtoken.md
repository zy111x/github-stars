...
var older\_token \= jwt.sign({ foo: 'bar', iat: Math.floor(Date.now() / 1000) \- 30 }, 'shhhhh');
...
RSASSA-PKCS1-v1\_5 using SHA-256 hash algorithm

RS384

RSASSA-PKCS1-v1\_5 using SHA-384 hash algorithm

RS512

RSASSA-PKCS1-v1\_5 using SHA-512 hash algorithm
