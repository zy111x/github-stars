...
-   vue-data-ui - Vue 3 chart library with 50+ components. Official site: https://vue-data-ui.graphieros.com/
...
-   vue3-slot-calendar - A vue 3 calendar, datepicker component which supported lunar or date event, bootstrap style.
...
-   vue-hierarchy - Library to display hierarchical data
...
-   vue-code-block - Vue 3 CodeBlock - Highlight your code with ease using this syntax highlighting component powered by PrismJS or Highlight.js.
-   v-image-magnifier - A Vue 3 plugin that provides interactive image zoom functionality. Allow users to zoom in on an image by hovering over it, providing an enlarged view of the corresponding part of the image.
...
-   vue-mrz-scanner - A Vue component to scan MRZ on passports, visa cards, etc. It is based on Dynamsoft Label Recognizer.
-   vue-surf - A very customized animated svg wave Vue component. Online Demo
...
-   vue-mathlive A MathLive math editor (mathfield) for Vue.js
...
-   @kiyoaki\_w/vue-context - A customizable context menu component built for Vue2, supporting fontawesome icons.
...
-   vuedeux - Binding Solutions for Vue & Redux.
    ...
    -   vue-redux-prepare-props - Helper for use props of _Redux_ with _Vue.js_ using _Vuex_ and _Vuedeux_
...
-   hugoVueSFC - Vue Single-File Components (SFC) in Hugo.
...
-   devtools-next - The next iteration of Vue DevTools.
...
-   Vue - Official (Volar) - ⚡The Fastest Vue Language Support Extension
...
-   rails\_vue\_melt - Rails view with webpack=vue optimizer.
...
-   rapydml\_cmp - Vue-component pythonic generator, built on top of RapydML & RapydScript.
