...
`pip` or `uv` may be used in place of `pipx`
...
$ sherlock --help
usage: sherlock \[-h\] \[--version\] \[--verbose\] \[--folderoutput FOLDEROUTPUT\] \[--output OUTPUT\] \[--csv\] \[--xlsx\] \[--site SITE\_NAME\] \[--proxy PROXY\_URL\] \[--dump-response\]
                \[--json JSON\_FILE\] \[--timeout TIMEOUT\] \[--print-all\] \[--print-found\] \[--no-color\] \[--browse\] \[--local\] \[--nsfw\] \[--txt\] \[--ignore-exclusions\]
                USERNAMES \[USERNAMES ...\]
