...
-   druid/ui - Copy paste UI components & an Intercom inspired AI chatbot - elegant, easy to install, fully responsive and customisable. Built on top of shadcn/ui
...
-   extend-ui - Reusable components built on shadcn/ui to increase performance when building web applications.
...
-   plate-select-editor - A rich multi-select editor.
-   pqoqubbw - Open-source collection of smooth crafted animated icons for your projects.
...
-   roadmap-ui - Composable React components for building interactive roadmaps.
...
-   solanauth - Responsive Solana wallet authentication and account modal built on top of @solana/web3.js with NextAuth integration and shadcn/ui
...
-   supercharged-shadcn-components - A collection of ready-to-use components specializing in building simpler, type-safe react-hook-form components inspired by Material-UI and other libraries.
...
-   twblocks - Website blocks to copy/paste - based on shadcn & Radix using Tailwind and NextJS
...
-   swajp.me
-   Nathan's AI - An AI Chatbot acting as a Portfolio, built with shadcn/ui components.
...
-   midday-components - A collection of open-source components based on Midday features.
...
-   next-js-views-template - An open-source collection of reusable view components like Calendar, Table,etc built with Next.js and ShadCN. Easily copy and paste these pre-built UI elements into your project for fast, responsive, and customizable layouts.
