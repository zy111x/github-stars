...
mkdir foobar
php countries.php convert --format=json\_unescaped --format=csv

# or using the shorter \`-f\` syntax:
php countries.php convert -f json\_unescaped -f csv
...
GeoJSON outlines come from http://thematicmapping.org/downloads/world\_borders.php.
...
Flags are not licensed under the ODbL license; see https://en.wikipedia.org/wiki/Wikipedia:Copyright\_on\_emblems for more information.
