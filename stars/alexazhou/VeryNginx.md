...
-   include /opt/verynginx/verynginx/nginx\_conf/in\_external.conf;
-   include /opt/verynginx/verynginx/nginx\_conf/in\_http\_block.conf;
-   include /opt/verynginx/verynginx/nginx\_conf/in\_server\_block.conf;
